...
# 7168 panels for converged value
f = np.sqrt(0.113594362130445**2+0.113594362130445**2)
...
fit_bem = np.polyfit(np.log(hbem)[1:],np.log(abs(fbem-f)/f)[1:],1)
...
# Volume formula
annotation.slope_marker((0.03, 1.5e-3), (1.09, 1),ax = ax)
# Bem bdry formula
#annotation.slope_marker((0.03, 3e-2), (0.31, 1),ax = ax)
# Bem sg formula
#annotation.slope_marker((0.03, 1.2e-4), (1.32, 1),ax = ax)
