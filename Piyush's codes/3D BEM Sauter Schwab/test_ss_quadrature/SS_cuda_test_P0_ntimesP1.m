...
GalerkinMatrix_gpu = gpuArray.zeros(P0.ndof,P1.ndof);
...
[sd,gmat] = feval(kernel,...
    P1.ndof,P0.ndof,bndmesh.nelt,bndmesh.nvtx,...
...
% 
% tic;
% K = panel_assembly(bndmesh,KK,ntimes(P1),P0,ii(:),jj(:));
% 
% elapsed_time = toc;
