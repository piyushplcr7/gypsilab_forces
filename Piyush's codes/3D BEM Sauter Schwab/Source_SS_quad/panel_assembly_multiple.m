...
function M = panel_assembly_multiple(mesh,kernel,trial_space,test_space, I, J,Vel,DVel)
              ...
              case 'P1'
                  ...
                  switch tr_opr
                      ...
                      case 'nxgrad[psi]'  % Trial: nxgrad(P1), Test: nxgrad(P1)
                          ...
                          if isempty(DVel{1}) % Proceed as normal
                                for ii = 1:Qts
                          ...
                          else % Shape derivative computation using DVel
