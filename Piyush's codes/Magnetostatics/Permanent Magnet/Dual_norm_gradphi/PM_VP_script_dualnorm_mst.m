...
PM_VP_dualnorm_gradphi_mst(@getMeshCuboid5, valsrest, @divcurlfreeM1);
PM_VP_dualnorm_gradphi_mst(@getMeshCuboid5, valsrest, @divcurlfreeM2);
...
PM_VP_dualnorm_gradphi_mst(@getMeshSphere, valsrest, @divcurlfreeM1);
PM_VP_dualnorm_gradphi_mst(@getMeshSphere, valsrest, @divcurlfreeM2);
