function [] = PM_VP_dualnorm_gradphi(meshfunction,vals,M)

    funcInfo = functions(meshfunction);
    MfuncInfo = functions(M);
    disp(['PM VP dualnorm invoked with: ', funcInfo.function, ' ', MfuncInfo.function]);
    disp("===================================================");
...
%         M = @(X) ones(size(X,1),1) * [1 0 0];
    ...
    %     rcond(full(testmat))
        ...
        fname = "PMVP_dualnorm_" + funcInfo.function + "_" + MfuncInfo.function+ ".mat";
