function [] = PM_VP_dualnorm_gradphi_mst(meshfunction,vals,M)

    funcInfo = functions(meshfunction);
    MfuncInfo = functions(M);
    disp(['PM VP dualnorm mst invoked with: ', funcInfo.function, ' ', MfuncInfo.function]);
    disp("===================================================");
...
%         M = @(X) ones(size(X,1),1) * [1 0 0];
    ...
    %     rcond(full(testmat))
        ...
        fname = "PMVP_dualnorm_MST" + funcInfo.function + "_" + MfuncInfo.function+ ".mat";
