% Solving a Neumann Problem using the Direct Second kind method
% Neumann problem is not uniquely solvable, check!!!

function [TNA_sol_DIV0_coeffs] = Neumann_DSK(TDA,DIV0)
    bndmesh = DIV0.msh;
    Gamma = dom(bndmesh,3);
