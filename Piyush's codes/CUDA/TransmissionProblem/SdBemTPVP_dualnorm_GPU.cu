            ...
            for (int ii = 0; ii < 3; ++ii)
            {
                ...
                for (int jj = 0; jj < 3; ++jj)
                {
                    ...
                    for (int QudPt = 0; QudPt < NQudPts; ++QudPt)
                    {
                        ...
                        // A1 with RWG . RWG
                        LocalMatrixA1(ii, jj) += W[QudPt] * KernelA1(__ldg(&abc_alpha[4 * fieldIdx]),     //
                        ...
                        LocalMatrixA2(ii, jj) += W[QudPt] * KernelA2(chi_tau, chi_t, chi_t - chi_tau) * (DVel(__ldg(&abc_alpha[4 * fieldIdx]),     //
                                                                                                              __ldg(&abc_alpha[4 * fieldIdx + 1]), //
                                                                                                              __ldg(&abc_alpha[4 * fieldIdx + 2]), //
                        ...
                        LocalMatrixC1(ii, jj) += W[QudPt] * (KernelC1(chi_tau, chi_t, chi_t - chi_tau).cross(DVel(__ldg(&abc_alpha[4 * fieldIdx]),     //
                                                                                                                  __ldg(&abc_alpha[4 * fieldIdx + 1]), //
                                                                                                                  __ldg(&abc_alpha[4 * fieldIdx + 2]), //
                                                                                                                  __ldg(&abc_alpha[4 * fieldIdx + 3]), chi_t) *
                                                                                                             Psiy))
                        ...
                        // C3 with RWG X RWG
                        LocalMatrixC3(ii, jj) += W[QudPt] * (KernelC3(__ldg(&abc_alpha[4 * fieldIdx]),     //
                                                                      __ldg(&abc_alpha[4 * fieldIdx + 1]), //
                                                                      __ldg(&abc_alpha[4 * fieldIdx + 2]), //
                                                                      __ldg(&abc_alpha[4 * fieldIdx + 3]), chi_tau, chi_t, chi_t - chi_tau)
                                                                 .cross(Psiy))
                        ...
                        LocalMatrixN(ii, jj) += W[QudPt] * KernelA1(__ldg(&abc_alpha[4 * fieldIdx]),     //
                                                                    __ldg(&abc_alpha[4 * fieldIdx + 1]), //
                                                                    __ldg(&abc_alpha[4 * fieldIdx + 2]), //
                                                                    __ldg(&abc_alpha[4 * fieldIdx + 3]), chi_tau, chi_t, chi_t - chi_tau) *
                                                4 * fluxI * fluxJ;
